...
import org.example.WordService;
...
public class OhceTest {
  ...
  @Spy @InjectMocks private Ohce ohce;

  @Mock private TimeService timeService;

  @Mock private WordService wordService;

  @Mock private ConsoleService consoleService;
  ...
  public void buenasDias_givenName_returnBuenasDiasName() {
    assertThat(ohce.buenasDias("Pablo")).isEqualTo("¡Buenas dias Pablo!");
  }
  ...
  @Test
  public void
      processWords_givenGivenReverseWordResponse_getConsoleWriteLineIsCalledUntilStopCommand() {
  ...
  @Test
  public void
      getReverseWordResponse_givenPalindrome_returnWordServiceReverseResponseAndBonitaPalabra() {
    doReturn("a").when(wordService).reverseWord(anyString());
  ...
  public void getReverseWordResponse_givenNonWord_returnPleaseEnterWord() {
    ...
    assertThat(reverseWord)
        .isEqualTo(
            "Please enter a word that is made up only of letters! "
